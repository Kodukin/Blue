...
@Component({
  selector: 'app-check-availability3',
  standalone: true,
  imports: [
    FormsModule,
    NgIf,
  ...
  templateUrl: './check-availability3.component.html',
  styleUrl: './check-availability3.component.css'
})
export class CheckAvailability3Component{ 
